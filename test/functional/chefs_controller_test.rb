...
class ChefsControllerTest < ActionController::TestCase
  ...
  test "should create chef" do
    assert_difference('Chef.count') do
      post :create, chef: { abbreviation: @chef.abbreviation, first_name: @chef.first_name, last_name: @chef.last_name }
    end
  ...
  test "should update chef" do
    put :update, id: @chef, chef: { abbreviation: @chef.abbreviation, first_name: @chef.first_name, last_name: @chef.last_name }
    assert_redirected_to chef_path(assigns(:chef))
  end
